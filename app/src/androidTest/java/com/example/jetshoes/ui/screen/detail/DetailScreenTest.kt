...
import com.example.jetshoes.onNodeWithStringId
...
class DetailScreenTest{
    ...
    private val fakeOrderReward = OrderReward(
        reward = Reward(4, R.drawable.img_4, "Nike Blazer", 12,"color","haloguys3", 1000),
        count = 0
    )
        ...
        composeTestRule.setContent {
            JetShoesTheme {
                DetailContent(
                    ...
                    fakeOrderReward.reward.color,
                    fakeOrderReward.reward.size,
                    fakeOrderReward.reward.description,
